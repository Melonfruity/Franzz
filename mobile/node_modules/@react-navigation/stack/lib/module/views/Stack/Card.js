...
export default class Card extends React.Component {
        ...
        case GestureState.END:
          {
            ...
            const closing = Math.abs(translation + velocity * gestureVelocityImpact) > distance / 2 ? velocity !== 0 || translation !== 0 : false;
            this.animate({
              closing,
              velocity
            });
  ...
  render() {
    ...
    }, rest), overlayEnabled && overlayStyle ? React.createElement(Animated.View, {
      pointerEvents: "none",
